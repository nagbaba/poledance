...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div class="right"></div>
  <div class="heading">
    <h1 style="color:#AD2E76;">Add New Competitor </h1>
  </div>
...
252); border: 1px solid  #E8E8E8; padding: 10px;">
	<form name="addcompetitorform" id="addcompetitorform" method="post" action="<?php echo base_url();?>admin/user/addcompetitor/insert/" enctype="multipart/form-data">
      ...
      <tr>
        <td height="45" colspan="7"><table width="100%" height="42" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="69%" align="left"><span class="btn_bx"><input type="button" name="clear" id="clear" value="Cancel" tabindex="16" onclick="location.href='<?php echo base_url();?>admin/user/managecompetitor/'"/></span></td>
