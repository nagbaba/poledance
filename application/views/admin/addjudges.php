...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div class="right"></div>
  <div class="heading">
    <h1 style="color:#AD2E76;">Add New Judge Details </h1>
  </div>
...
252); border: 1px solid  #E8E8E8; padding: 10px;">
	<form name="addjudgesform" id="addjudgesform" method="post" action="<?php echo base_url();?>admin/user/addjudges/insert/" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="34%" height="45" align="left"><input type="text" value="" class="tb3" style="width:280px;" tabindex="1" name="FirstName" id="FirstName" maxlength="50"  onkeyup="trimFirstSpace('FirstName');" onkeypress="enterPage('addnewjudgesbutton', event);" /></td>
        <td width="12%" height="45" align="left"><span class="box_title">Last Name <span class="asterick">*</span></span></td>
        <td width="3%" align="center"><span class="box_title">:</span></td>
        <td width="32%" height="45" align="left"><input type="text" value="" class="tb3" style="width:280px;" tabindex="2" name="LastName" id="LastName" maxlength="50" onkeyup="trimFirstSpace('LastName');"  onkeypress="enterPage('addnewjudgesbutton', event);"/></td>
      </tr>
      ...
      <tr>
        <td height="37">&nbsp;</td>
        <td height="37" align="left"><span style="padding-top:10px;"><span class="box_title">Head judge</span></span></td>
        <td height="37" align="center"><span class="box_title">:</span></td>
        <td height="37" align="left"><input type="checkbox" name="IsHead" id="IsHead" value="1" /></td>
      ...
      <tr>
        <td height="45" colspan="7"><table width="100%" height="42" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="69%" align="left"><span class="btn_bx"><input type="button" name="clear" id="clear" value="Cancel" tabindex="13" onclick="location.href='<?php echo base_url();?>admin/user/managejudges/'"/></span></td>
