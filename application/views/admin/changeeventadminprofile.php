...
252); border: 1px solid  #E8E8E8; padding: 10px;">
	<form name="updateediteventadminform" id="updateediteventadminform" method="post" action="<?php echo base_url();?>admin/user/editeventadminmyprofile/" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="45" align="left">&nbsp;</td>
        <td height="45" align="center">&nbsp;</td>
        <td height="45" align="left" valign="top"><input type="file" name="ProfileImage" id="ProfileImage" class="tb1" size="20" tabindex="11" /></td>
        <td height="45" align="left">&nbsp;</td>
        <td height="45" align="left">&nbsp;</td>
        <td height="45" align="left">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td height="45" colspan="7"><table width="100%" height="42" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="8%" align="left"><span class="btn_bx"><input type="button" name="updateeventadminbutton" id="updateeventadminbutton" value="Update" onClick="return validateEditEventadmin('E');" tabindex="12"></span> 
            ...
            <td width="69%" align="left"><span class="btn_bx"><input type="button" name="clear" id="clear" value="Cancel" tabindex="13" onclick="location.href='<?php echo base_url();?>admin/home/eventadminhomepage/'"/></span></td>
